...
This project is an interactive Finance Dashboard developed in Qlik Cloud to monitor financial performance, contract lifecycle, and risk indicators. 

It enables users to analyze key metrics such as outstanding amounts, interest rates, collections, and delinquency trends through a centralized and user-friendly interface.
